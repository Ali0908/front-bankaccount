...
describe('CashWithdrawal', () => {
  ...
  beforeEach(async () => {
    ...
    mockBankAccountService.withdraw.and.returnValue(of({ id: 1, accountNumber: 'ACC001', balance: 900 }));
  ...
  it('should call withdraw when modal returns data', () => {
    mockDialog.open.and.returnValue({ afterClosed: () => of({ accountNumber: 'ACC001', amount: 100 }) } as any);
